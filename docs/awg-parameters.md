...
description: "Чем AmneziaWG отличается от WireGuard, что добавила каждая версия от 1.0 до 3.0, какие параметры обязаны совпадать с сервером, а какие настраиваются только у клиента, и как выбрать MTU."
head:
  - - meta
    - name: keywords
...
*   **[Инструкции Shidla](https://gitlab.com/ShidlaSGC/amn-instructions/)** — определение версий, признаки 3.1 и практические сценарии.
