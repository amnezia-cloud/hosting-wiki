...
Материал этой страницы собран на основе **[FAQ генератора ARCHITECT](https://architect.vai-rice.space/faq)** — там же приводятся ссылки на места в коде, из которых следует описанное поведение.
